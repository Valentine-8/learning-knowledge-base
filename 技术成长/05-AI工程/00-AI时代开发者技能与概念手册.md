...
| [03-7年Java工程师学习路线.md](../01-Java/00-导航与面试/03-7年Java工程师学习路线.md) | Java 主线 |
| [04-个人基线评估.md](../00-通用/04-个人基线评估.md) | AI 技能自评（第十节） |
| [03-学习进度追踪.md](../00-通用/03-学习进度追踪.md) | AI 阶段勾选 |
| [12-项目实战清单.md](../00-通用/12-项目实战清单.md) | P13～P15 AI 项目 |
| [08-资源书签.md](../00-通用/08-资源书签.md) | AI 工具链接 |
...
建议 **并行** 而非 **替代** 原 [03-7年Java工程师学习路线.md](../01-Java/00-导航与面试/03-7年Java工程师学习路线.md)：
...
| 动作 | 文档 |
|------|------|
| AI 技能自评 | [04-个人基线评估.md](../00-通用/04-个人基线评估.md) 第十节 |
| AI 阶段勾选 | [03-学习进度追踪.md](../00-通用/03-学习进度追踪.md) AI 进度 |
| AI 项目 | [12-项目实战清单.md](../00-通用/12-项目实战清单.md) P13～P15 |
| AI 写代码 / Review | [13-AI时代程序员与代码.md](./13-AI时代程序员与代码.md) |
| Prompt/概念踩坑 | [05-错题与易忘概念.md](../00-通用/05-错题与易忘概念.md) AI 章节 |
| 每周复盘 | [13-周复盘模板.md](../00-通用/13-周复盘模板.md) |
