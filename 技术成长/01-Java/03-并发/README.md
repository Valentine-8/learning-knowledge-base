...
> **速览**：Phase3 [复习手册](../笔记/phase3-并发/00-复习手册.md)（45 min）
...
- JVM 内存与 GC：[笔记/phase2-JVM](../笔记/phase2-JVM/00-复习手册.md)
- 并发集合：[笔记/phase1-集合/ConcurrentHashMap](../笔记/phase1-集合/03-ConcurrentHashMap.md)
- Spring 异步陷阱：[Spring/06-事务传播与失效](../04-Spring/06-事务传播与失效.md)（`@Async` 与事务）
- 分布式限流：[SpringCloud/06-Sentinel](../05-SpringCloud/06-Sentinel与Seata.md)
