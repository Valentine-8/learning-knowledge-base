...
> **原则**：Agent 改完代码 → **你先 diff Review** → 再 commit（见 [AI时代程序员与代码.md](../AI工程/AI时代程序员与代码.md)）。
...
| AI 与代码 | [AI时代程序员与代码.md](../AI工程/AI时代程序员与代码.md) |
...
| 文档 | 用途 |
|------|------|
| [AI时代程序员与代码.md](../AI工程/AI时代程序员与代码.md) | Agent 改代码怎么 Review |
