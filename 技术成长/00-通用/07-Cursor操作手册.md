...
> **原则**：Agent 改完代码 → **你先 diff Review** → 再 commit（见 [13-AI时代程序员与代码.md](../05-AI工程/13-AI时代程序员与代码.md)）。
...
- 本仓库：`03-求职面试/08-面试前速查.md`  
- C++ 岗：`04-C++嵌入式/08-面试前速查-C++嵌入式.md`  
...
| AI 与代码 | [13-AI时代程序员与代码.md](../05-AI工程/13-AI时代程序员与代码.md) |
...
| 文档 | 用途 |
|------|------|
| [13-AI时代程序员与代码.md](../05-AI工程/13-AI时代程序员与代码.md) | Agent 改代码怎么 Review |
| [01-阅读指南.md](./01-阅读指南.md) | 学习文档阅读顺序 |
