...
> **速览**：Phase6 [复习手册](../笔记/phase6-分布式/复习手册.md)（45 min）
...
| 主题 | 文档 |
|------|------|
| **消息队列**（Kafka/RocketMQ、可靠性、幂等） | [数据与中间件/消息队列](../../数据与中间件/消息队列/README.md) |
| **Redis 分布式锁**（SET NX、Redisson、看门狗） | [Redis/04-分布式锁](../../数据与中间件/Redis/04-分布式锁与并发.md) |
| **Seata / Sentinel 实战** | [SpringCloud/06](../SpringCloud/06-Sentinel与Seata.md) |
| **Nacos 注册与配置** | [SpringCloud/02～03](../SpringCloud/02-Nacos注册发现.md) |
