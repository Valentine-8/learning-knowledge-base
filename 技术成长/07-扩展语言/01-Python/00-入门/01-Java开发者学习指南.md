...
| 对照文档随时翻 [附录-Java与Python对照](../99-附录-Java与Python对照.md) | 语法差异集中查 |
| **手敲** Java 里写过的小逻辑（如读文件统计词频） | 用 Python 重写一遍比只看语法有效 |
| 01～07 扎实，08～10 可加速 | OOP 你已懂，重点看 Python 特有写法 |
| 13 章（requests/AI）是你的**主业延伸** | 配合 [AI工程](../../../05-AI工程/README.md) |
...
| 天 | 内容 |
|----|------|
| D1 | 01 安装 + [附录对照](../99-附录-Java与Python对照.md) 通读一遍 |
| D2 | 02 变量类型 |
| D3 | 03 字符串 |
...
| 读 [AI工程](../../../05-AI工程/README.md) 时对照 Python 示例 |
...
|-----------|-------------------|
| [AI工程/](../../../05-AI工程/README.md) | Java 写生产；Python 试 prompt、批评测 |
| [数据与中间件/01-MySQL/](../../../02-数据与中间件/01-MySQL/README.md) | SQL 一样；Python 做导数分析脚本 |
| [Java/笔记/phase3-并发/](../../../01-Java/笔记/phase3-并发/00-复习手册.md) | 对照学 GIL、asyncio |
| [扩展技能全景](../../../01-扩展技能全景.md) | Python P1 优先级 |
...
← [Python 目录](../README.md) · 详细周计划 → [02-学习路线图](./02-学习路线图.md)
