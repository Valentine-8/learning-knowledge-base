...
RENAMES: list[tuple[str, str]] = [
    ...
    # Java root files
    ("技术成长/01-Java/00-导航与面试/01-7年Java工程师技能清单.md", "技术成长/01-Java/00-导航与面试/01-7年Java工程师技能清单.md"),
    ("技术成长/01-Java/00-导航与面试/02-7年工程师技能全景索引.md", "技术成长/01-Java/00-导航与面试/02-7年工程师技能全景索引.md"),
    ("技术成长/01-Java/00-导航与面试/03-7年Java工程师学习路线.md", "技术成长/01-Java/00-导航与面试/03-7年Java工程师学习路线.md"),
    ("技术成长/01-Java/00-导航与面试/04-java学习.md", "技术成长/01-Java/00-导航与面试/04-java学习.md"),
    ("技术成长/01-Java/00-导航与面试/05-简历.md", "技术成长/01-Java/00-导航与面试/05-简历.md"),
    ("技术成长/01-Java/00-导航与面试/06-项目经历面试手册.md", "技术成长/01-Java/00-导航与面试/06-项目经历面试手册.md"),
    ("技术成长/01-Java/00-导航与面试/07-面试题大全Q&A.md", "技术成长/01-Java/00-导航与面试/07-面试题大全Q&A.md"),
    ("技术成长/01-Java/00-导航与面试/08-面试前速查.md", "技术成长/01-Java/00-导航与面试/08-面试前速查.md"),
    ("技术成长/01-Java/00-导航与面试/09-系统设计练手.md", "技术成长/01-Java/00-导航与面试/09-系统设计练手.md"),
    # Java topic folders
    ...
    ("技术成长/06-C++嵌入式/00-导航与面试/08-面试前速查-C++嵌入式.md", "技术成长/06-C++嵌入式/00-导航与面试/08-面试前速查-C++嵌入式.md"),
