...
| 现有位置 | 目标位置 | 处理方式 |
|---|---|---|
| `01-Java/03-集合框架/` | `01-Java/03-集合框架/` | 拆分、重命名、补齐章节 |
...
| `03-Database/02-MySQL/` | `03-Database/02-MySQL/` | 复用深度内容并规范文件名 |
| `04-Redis/` | `04-Redis/` | 复用并补齐生产实践 |
| `05-Message-Queue/` | `05-Message-Queue/` | 按 Kafka、RocketMQ、通用 MQ 拆分 |
| `06-Middleware/01-Elasticsearch/` | `06-Middleware/01-Elasticsearch/` | 迁移并补齐集群与性能 |
| `16-Computer-Science/` | `16-Computer-Science/` | 按算法、网络、OS、安全迁移 |
| `18-AI-Engineering/` | `18-AI-Engineering/` | 按 Prompt、RAG、Agent、MCP 拆分 |
| `19-Cpp/01-语言与嵌入式/` | `19-Cpp/`、`21-Interview/` | 技术内容与求职内容分离 |
| `99-Archive/Frontend-Demos/Vue2-Basic/` | `99-Archive/Frontend-Demos/Vue2-Basic/` | 保留历史 Demo，不作为正式 Vue3 知识 |
| `98-Personal-Topics/Photography/Olympus-EP7/` | `98-Personal-Topics/Photography/Olympus-EP7/` | 保留个人摄影专题 |
| `90-Growth/01-学习方法/` | `90-Growth/`、`21-Interview/`、`99-Archive/` | 按成长、面试、归档拆分 |
