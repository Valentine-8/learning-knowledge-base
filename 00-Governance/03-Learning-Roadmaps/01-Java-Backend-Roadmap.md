...
| [7年Java工程师技能清单.md](./7年Java工程师技能清单.md) | 技能目标 |
| [统一主路线.md](../00-通用/统一主路线.md) | Java + AI 并行时间表 |
| [学习进度追踪.md](../00-通用/学习进度追踪.md) | **按 Phase 勾选任务** |
| [项目实战清单.md](../00-通用/项目实战清单.md) | Demo 与综合项目 |
| [个人基线评估.md](../00-通用/个人基线评估.md) | Phase 0 自评 |
| [notes/](./笔记/) | 分 Phase 笔记 |
| [资源书签.md](../00-通用/资源书签.md) | 学习链接 |
...
### 推荐资源
- 自评对照：[7年Java工程师技能清单.md](./7年Java工程师技能清单.md)
...
| 源码 | [Spring 源码系列](https://www.iocoder.cn/categories/Spring/) |
...
[notes/phase1-集合/ArrayList.md](./笔记/phase1-集合/ArrayList.md) 已有 ArrayList 源码分析，建议：
...
3. 每完成 Phase，更新 [个人基线评估.md](../00-通用/个人基线评估.md) 与 [学习进度追踪.md](../00-通用/学习进度追踪.md)  
