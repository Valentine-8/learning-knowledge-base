...
| 现有位置 | 目标位置 | 处理方式 |
|---|---|---|
| `技术成长/Java/笔记/phase1-集合/` | `01-Java/03-集合框架/` | 拆分、重命名、补齐章节 |
| `技术成长/Java/笔记/phase2-JVM/` | `08-JVM/` | 按 JVM 模块迁移 |
| `技术成长/Java/笔记/phase3-并发/` | `09-Concurrency/` | 按 JUC、线程池、锁拆分 |
| `技术成长/Java/笔记/phase4-Spring/` | `02-Spring-Ecosystem/` | 按 Spring 子项目迁移 |
| `技术成长/Java/笔记/phase5-数据库/` | `03-Database/` | 与 MySQL 内容合并去重 |
| `技术成长/Java/笔记/phase6-分布式/` | `10-Distributed-Systems/` | 按一致性、事务、工程问题迁移 |
| `技术成长/Java/笔记/phase7-架构/` | `11-Architecture/` | 按架构主题迁移 |
| `技术成长/Java/笔记/phase8-DevOps/` | `15-DevOps/` | 按 Git、CI/CD、环境治理迁移 |
| `技术成长/数据与中间件/MySQL/` | `03-Database/02-MySQL/` | 复用深度内容并规范文件名 |
| `技术成长/数据与中间件/Redis/` | `04-Redis/` | 复用并补齐生产实践 |
| `技术成长/数据与中间件/消息队列/` | `05-Message-Queue/` | 按 Kafka、RocketMQ、通用 MQ 拆分 |
| `技术成长/数据与中间件/Elasticsearch/` | `06-Middleware/01-Elasticsearch/` | 迁移并补齐集群与性能 |
| `技术成长/计算机基础/` | `16-Computer-Science/` | 按算法、网络、OS、安全迁移 |
| `技术成长/AI工程/` | `18-AI-Engineering/` | 按 Prompt、RAG、Agent、MCP 拆分 |
| `技术成长/C++嵌入式/` | `19-Cpp/`、`21-Interview/` | 技术内容与求职内容分离 |
| `前端/vue/` | `99-Archive/Frontend-Demos/Vue2-Basic/` | 保留历史 Demo，不作为正式 Vue3 知识 |
| `奥林巴斯ep7/EP7-Guide/` | `98-Personal-Topics/Photography/Olympus-EP7/` | 保留个人摄影专题 |
| `技术成长/00-通用/` | `90-Growth/`、`21-Interview/`、`99-Archive/` | 按成长、面试、归档拆分 |
